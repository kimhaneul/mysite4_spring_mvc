...
<link href="/mysite4_spring_mvc/assets/css/user.css" rel="stylesheet" type="text/css">
...
<body>
	<div id="container">
		...
		<div id="content">
			<div id="user">
				<form id="join-form" name="joinForm" method="post" action="/mysite4_spring_mvc/user/join">
					...
					<img id="image-checked" style="width:16px;display:none" src="/mysite4_spring_mvc/assets/images/check.png"/>
